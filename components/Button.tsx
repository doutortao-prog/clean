...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'unger' | 'elcastor';
  isLoading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    unger: "border-transparent text-white bg-unger-green hover:bg-unger-dark focus:ring-green-500",
    elcastor: "border-transparent text-white bg-elcastor-red hover:bg-elcastor-dark focus:ring-red-500",
  };
